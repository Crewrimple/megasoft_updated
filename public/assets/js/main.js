document.addEventListener("DOMContentLoaded", () => {
  ...
  linkImages.forEach((linkImage) => {
    const portfolioItemLink = linkImage.closest(".portfolio__item").querySelector(".portfolio__item-link");
  ...
  function closeModal() {
    ...
    document.body.style.overflow = "";
    const alertElements = modal.querySelectorAll('.alert');
  ...
  function openModal() {
    ...
    if (successMessage) {
      ...
      modal.querySelector('.modal__wrapper').prepend(successDiv);
    }

    if (errorMessage) {
      const errorDiv = document.createElement('div');
      errorDiv.classList.add('alert', 'alert-danger');
      errorDiv.textContent = errorMessage.textContent;
      modal.querySelector('.modal__wrapper').prepend(errorDiv);
    }
  ...
  inputEl.forEach((input) => {
    input.addEventListener("focus", () => {
      const label = input.closest(".input__wrapper").querySelector(".input__label");
