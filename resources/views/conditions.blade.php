...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <header class="header">
        <!-- Start ABOUT banner -->
        <div class="conditions__banner page__banner-bg">
          <div class="container">
            <div class="conditions">
              <h1 class="conditions__title">Foydalanish shartlari</h1>
              <div class="conditions__links">
                <a href="index.html" class="conditions__home">Bosh sahifa</a>
                <span class="conditions__link-sign"
                  ><i
                    class="conditions__icon fa-solid fa-chevron-right"
                    style="color: #ffffff"
                  ></i
                ></span>
                <a href="conditions.html" class="conditions__link"
      ...
      <main class="main">
        <div class="container">
          <div class="content">
            <h3 class="content__title">Terms & Conditions</h3>
