          ...
          <div class="header-banner">
            <div class="banner__text">
              <div class="banner__title">
                <h1 class="banner__theme">
                  Bitta aj<span class="header__special-letter"
                    ><img
                      class="special-letter__item"
                      src="assets/icons/ONE EXCELLENT.svg"
                      alt="One excelent" /></span
                  >yib g'oya<br />Hay<span class="header__special-letter"
                    ><img
                      class="special-letter__item"
                      src="assets/icons/ONE EXCELLENT (1).svg"
                      alt="One excelent" /></span
                  >tinggizni<br />o'zga<span class="header__special-letter"
                    ><img
                      class="special-letter__item"
                      src="assets/icons/Letter R.svg"
                      alt="One excelent" /></span
                  >tirishi <br />
                  m<span class="header__special-letter"
                    ><img
                      class="special-letter__item"
                      src="assets/icons/YOUR LIFE.svg"
                      alt="One excelent" /></span
                  >mkin
                </h1>
              ...
              <div class="banner__info">
                <p class="banner__desc main-text">
                  Tuzilishni loyihalashda sahifaning oʻqilishi mumkin boʻlgan
                  mazmuni oʻquvchini chalgʻitmasligi va uning umumiy tajribasini
                  oshirishiga ishonch hosil qilish juda muhim.
                </p>
                <button class="banner__btn main-btn open__modal-btn">
                  Boshlash
                </button>
              </div>
            </div>
      ...
      <main class="main">
        ...
        <section id="main__section">
          ...
          <div class="container">
            ...
            <div class="services">
              <div class="services-info">
                ...
                <p class="services-desc main-text">
                  Hayotingizni osonlashtirish va qimmatli vaqtingizni tejash
                  uchun mo’ljallangan xizmatlarimiz bilan tanishing.
                </p>
              </div>
              <div class="services-content">
                <div class="services-content-row">
                  <div class="services-content__cards main-cards">
                    ...
                    <a href="services.html" class="services__cards-link">
                      <img
                  ...
                  <div class="services-content__cards main-cards">
                    <div class="services__main-content">
                      ...
                      <p class="services__cards-desc main-text">
                        ...
                        uchun maxsus ishlab chiqilgan dasturiy ilovalarni
                        yaratish jarayoni.
                      </p>
                    </div>
                    <a href="services.html" class="services__cards-link">
                  ...
                  <div class="services-content__cards main-cards">
                    <div class="services__main-content">
                      ...
                      <p class="services__cards-desc main-text">
                        ...
                        tovarlarni Internet orqali sotishga mo’ljallangan
                        veb-sayt.
                      </p>
                    </div>
                    <a href="services.html" class="services__cards-link">
                  ...
                  <div class="services-content__cards main-cards">
                    <div class="services__main-content">
                      ...
                      <p class="services__cards-des main-text">
                        ...
                        boshqalar kabi turli xil vositalar uchun yozma
                        materiallar yaratish jaryoni.
                      </p>
                    </div>
                    <a href="services.html" class="services__cards-link">
                      <img
            ...
            <!--====================================== Start PROFESSION__TITLE section ======================================-->
            <div class="title__profession">
              <h2 class="main-title">Bizning yondashuvimiz</h2>
              <p class="main-text">
                Yangi bilim,tushuncha yoki tushunchaga ega bo’lish uchun muayyan
                mavzuni tizimli tekshirish,o’rganish va tahlil qilish.
              </p>
            </div>
            <!-- /PROFESSION__TITLE -->
            ...
            <div class="profession">
              <div class="profession__imgs-wrapper">
                <div class="profession__img">
                  <img src="images/Group-img.jpg" alt="Group Work" />
                </div>
                <div class="profession__collection">
                  <div class="collection__items profession__img">
                    <img src="images/Project-ig.jpg" alt="Project" />
                  </div>
                  <div class="collection__items profession__img">
                    <img src="images/People-img.jpg" alt="Project" />
                  </div>
                </div>
              </div>
              <div class="profession__cards">
                <!-- ****************************** -->
                <div class="profession__cards-item main-cards">
                  <img
                    src="assets/icons/search 02.svg"
                    alt="Crm platform"
                    class="profession__cards-icon"
                  />
                  <h3 class="profession__cards-title main-cards__title">
                    Tadqiqot
                  </h3>
                  <p class="profession__cards-desc main-text">
                ...
                <div class="profession__cards-item main-cards">
                  ...
                  <p class="profession__cards-desc main-text">
                    ...
                    jozibali, foydalanuvchilarga qulay va funktsional saytlarni
                    yaratishdir.
                  </p>
                </div>
                <!-- ****************************** -->
                <div class="profession__cards-item main-cards">
                  ...
                  <p class="profession__cards-desc main-text">
                    Rivojlanish yani biror narsani yaratish qurish va uni yanada
            ...
            <img
              ...
              alt="Cervices"
              class="main__section-icons profession__before"
            />
          </div>
          <!-- /CONATAINER -->
        </section>
        ...
        <div class="container">
          ...
          <div class="portfolio">
            <div class="portfolio__info">
              <h3 class="portfolio__title main-title">Bizning portfelimiz</h3>
              <p class="portfolio__desc main-text">
                Biz o’z portfelimizga Ui/Ux dizaynlarimizni, veb-sayt
                dizaynlarni,banner va shunga o’xshash ishlarimizni joyladik.
              </p>
            </div>
              ...
              <div class="portfolio__col">
                ...
                <div class="portfolio__item">
                  <div class="portfolio__img-wrapper">
                    <a href="portfolio.html" class="portfolio__link-img">
                      <img
                  ...
                  <div class="portfolio__item-link">
                    <a href="portfolio.html" class="link__item">
                      <img
